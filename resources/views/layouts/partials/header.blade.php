                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div id="kt_docs_search" class="d-flex align-items-center w-lg-250px me-2 me-lg-5">
                                    ...
                                    <form method="GET" action="{{ route('contact.index') }}" class="d-block w-100 mb-lg-0 position-relative" >
                                        ...
                                        <input type="text" class="form-control form-control-solid h-40px ps-13 fs-7" id="searchNew" name="searchNew" value="{{request()->searchNew}}" placeholder="Search companies ..." data-kt-search-element="input">

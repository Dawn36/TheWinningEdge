...
@section('content')
                                        ...
                                        <div class="me-5">
                                            @if (Auth::user()->profile_picture)
                                                <img src="{{ asset('/profile/' . Auth::user()->profile_picture) }}"
                                                    class="dashboard-quill-img h-75px"
                                                    onerror="this.onerror=null; this.src='/profile/blank.png'"
                                                    alt="">
                                            @endif
                                        </div>
                                        <div class="d-flex flex-column">
                                            <a href="#" class="text-gray-900 text-hover-primary fs-6 fw-bolder">Hi,
                                                {{ ucwords(Auth::user()->first_name) }}
                                                {{ ucwords(Auth::user()->last_name) }}</a>
                                            <span class="text-gray-400 fw-bold">To do list:</span>
                                        </div>
                                    </div>
                                </div>
                                <form id="user_note_form" class="ql-quil ql-quil-plain  p-3 " method="POST"
                                    action="{{ route('user_note') }}">
                                    @csrf
                                    <!--begin::Editor-->
                                    ...
                                    <div id="kt_forms_widget_1_editor_toolbar" class="ql-toolbar d-flex flex-stack py-2">
                                        ...
                                        {{-- <button type="button" onclick="setToDoNote()" class="btn btn-icon btn-sm btn-primary btn-active-color-primary" style="background-color: #e7e2cc !important;">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="row gy-5 g-xl-10">
                            @if (Auth::user()->hasRole('admin'))
                                <div class="col col-md col-lg-12 col-xl-12 col-xxl">
                                    <div class="card overflow-hidden mb-lg-0 mb-5">
                                        <div class="card-body">
                            ...
                            @endif
                            <div class="col col-md col-lg-12 col-xl-12 col-xxl mt-xxl-10 mt-xl-5">
                        ...
                        <div class="row gy-5 g-xl-10">
                            <div class="col col-md col-lg-12 col-xl-12 col-xxl-6">
                            ...
                            <div class="col col-md col-lg-12 col-xl-12 col-xxl-6 mt-5 mt-xxl-10">
                                <div class="card overflow-hidden mb-5 ">
                                    <div class="card-body">
                                        <span class="svg-icon svg-icon-primary svg-icon-3x ms-n1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="card-header border-0">
                                ...
                                <div class="card-toolbar">
                                    <button type="button" class="btn btn-sm btn-icon btn-primary"
                                        data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" title=""
                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-original-title="Add new Task" onclick="addTask()">
                                        <span class="svg-icon svg-icon-2hx">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none">
                                                <rect opacity="0.6" x="11" y="18" width="12"
                                    ...
                                    @for ($i = 0; $i < count($task); $i++)
                                        <div class="d-flex align-items-center mb-6">
                                            <span class="bullet bullet-vertical h-40px"
                                                style="background-color: #c5ad60;"></span>
                                            <div class="form-check form-check-custom form-check-solid mx-5">
                                                <input class="form-check-input" type="checkbox" value=""
                                                    onclick="taskStatusUpdate('{{ $task[$i]->id }}',this,'Completed')" />
                                            </div>
                        ...
                        <div class="card card-xl-stretch mb-xl-8 mb-5">
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Revenue Producing Activity - Monthly
                                        Target</span>
                                    ...
                                    <table class="table align-middle gs-0 gy-5">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('theme/assets/media/logos/rpa.png') }}"
                                                ...
                                                <td>
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary mb-1 fs-7">Revenue
                                                        Producing Activities</a>
                                                    <span class="text-muted fw-bold d-block fs-8">Due:
                                                        {{ Date('01-m-Y', strtotime('+1 month')) }}</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column w-100 me-2">
                                                        <div class="d-flex flex-stack mb-2">
                                                            <span
                                                                class="text-muted me-2 fs-7 fw-bold">{{ round($rpaPercentage, 2) >= 100 ? '100' : round($rpaPercentage, 2) }}%</span>
                                                        </div>
                                                        <div class="progress h-6px w-100">
                                                            <div class="progress-bar {{ round($rpaPercentage, 2) >= 100 ? 'bg-sucess' : 'bg-danger' }}"
                                                                role="progressbar"
                                                                style="width: {{ round($rpaPercentage, 2) >= 100 ? '100' : round($rpaPercentage, 2) }}%"
                                                ...
                                                <td class="text-end">
                                                    <button class="btn btn-primary btn-sm px-4" data-bs-toggle="modal"
                                                        onclick="setRpaTarget()" title="Set RPA Target">Set
                                                        Target</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img src="{{ asset('theme/assets/media/logos/opportunities.png') }}"
                                                                class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                </th>
                                                <td>
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary mb-1 fs-7">Opportunities
                                                        Target</a>
                                                    <span class="text-muted fw-bold d-block fs-8">Due:
                                                        {{ Date('01-01-Y', strtotime('+1 year')) }}</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column w-100 me-2">
                                                        <div class="d-flex flex-stack mb-2">
                                                            <span
                                                                class="text-muted me-2 fs-7 fw-bold">{{ round($percentage, 2) >= 100 ? '100' : round($percentage, 2) }}%</span>
                                                            <span
                                                                class="text-muted me-2 fs-7 fw-bold">${{ number_format(isset($amount[0]->amount) == 0 ? '0' : $amount[0]->amount) }}/${{ number_format(count($opportunitiesTarget) == 0 ? '0' : $opportunitiesTarget[0]->target) }}</span>
                                                        </div>
                                                        <div class="progress h-6px w-100">
                                                            <div class="progress-bar {{ round($percentage, 2) >= 100 ? 'bg-sucess' : 'bg-danger' }}"
                                                                role="progressbar"
                                                                style="width: {{ round($percentage, 2) >= 100 ? '100' : round($percentage, 2) }}%"
                                                ...
                                                <td class="text-end">
                                                    <button class="btn btn-primary btn-sm px-4"
                                                        onclick="setOpportunitiesTarget()"title="Set Opportunities Target">Target
                                                        Quota</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="card-rounded bg-body mt-n10 position-relative py-10">
                                    <div class="row g-0 justify-content-center">
                                        ...
                                        <div class="col-auto text-align-last-center mx-5">
                                            ...
                                            <div class="text-gray-800 fw-boldest fs-3 my-2">
                                                {{ number_format($amountAllOver[0]->amount, 2) }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        editorChild = document.getElementById('kt_forms_widget_1_editor').firstChild
        editorChild.addEventListener('focusout', () => {
            //   console.log('FOCUS OUT')
            setToDoNote()
        })

        function setToDoNote() {
            $.ajax({
                url: "{{ route('user_note') }}",
                method: 'POST',
                data: $('#user_note_form').serialize(),
                headers: {

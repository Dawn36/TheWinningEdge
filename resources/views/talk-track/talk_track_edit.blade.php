<form id="" class="form" method="POST" action="{{ route('best_practices.update',$talkTrack->id) }}" enctype="multipart/form-data">
    @method("PUT")
    @csrf
    <!--begin::Scroll-->
    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
        <div class="fv-row mb-7">
            ...
            <input type="text" required name="talk_track_name" value="{{$talkTrack->talk_track_name}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter The Name Of Your Best Practices." />
        </div>
        <div class="fv-row mb-7">

<form id="" class="form" method="POST" action="{{ route('contact.update',$contact->id) }}" enctype="multipart/form-data">
    ...
    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" required name="first_name" value="{{$contact->first_name}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your First Name here." />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Last Name</label>
            <input type="text" required name="last_name" value="{{$contact->last_name}}"  class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Last Name here." />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Job Title</label>
            <input type="text" required name="job" value="{{$contact->job}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Job Title here." />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Direct Phone Number</label>
            <input type="number" required min="0" value="{{$contact->phone_number}}" name="phone_number" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Direct Phone Number here." />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Email Address</label>
            <input type="email" required min="0" value="{{$contact->email}}" name="email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Email Address here." />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Mobile phone</label>
            <input type="number" required min="0" value="{{$contact->mobile_phone}}" name="mobile_phone" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Mobile phone here." />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Company Name</label>
            <input type="text" required min="0" value="{{$contact->company_name}}" name="company_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Company Name here." />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">LinkedIn Contact Profile URL</label>
            <input type="text" required name="linked_in_url" value="{{$contact->linked_in_url}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter the LinkedIn Contact Profile URL here." />
        </div>
    </div>
    <!--end::Scroll-->
    <!--begin::Actions-->

                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                                ...
                                                <center>
                                                    <a  onclick="addContactCounter('phone_call','{{$contact[$i]->id}}',this)" style="cursor: pointer;">
                                                        <div class="border border-gray-300 border-dashed rounded py-1 px-1 text-center">
                                                            ...
                                                            <div class="fw-bold text-muted fs-8">{{$contact[$i]->last_phone_call == '' ? '' : Date("Y-m-d h:i:s A",strtotime($contact[$i]->last_phone_call))}}</div>
                                                        </div>
                                                    </a>
                                                </center>
                                            </td>
                                                ...
                                                <center>
                                                    <a  onclick="addContactCounter('live_conversation','{{$contact[$i]->id}}',this)" style="cursor: pointer;">
                                                        <div class="border border-gray-300 border-dashed rounded py-1 px-1 text-center">
                                                            ...
                                                            <div class="fw-bold text-muted fs-8">{{$contact[$i]->last_live_conversation == '' ? '' : Date("Y-m-d h:i:s A",strtotime($contact[$i]->last_live_conversation))}}</div>
                                                        </div>
                                                    </a>
                                                </center>
                                            </td>
                                                ...
                                                <center>
                                                    <a  onclick="addContactCounter('voice_mail','{{$contact[$i]->id}}',this)" style="cursor: pointer;">
                                                        <div class="border border-gray-300 border-dashed rounded py-1 px-1 text-center">
                                                            ...
                                                            <div class="fw-bold text-muted fs-8">{{$contact[$i]->last_voic_mail == '' ? '' : Date("Y-m-d h:i:s A",strtotime($contact[$i]->last_voic_mail))}}</div>
                                                        </div>
                                                    </a>
                                                </center>
                                            </td>
                                                ...
                                                <center>
                                                    <a  onclick="addContactCounter('email','{{$contact[$i]->id}}',this)" style="cursor: pointer;">
                                                        <div class="border border-gray-300 border-dashed rounded py-1 px-1 text-center">
                                                            ...
                                                            <div class="fw-bold text-muted fs-8">{{$contact[$i]->last_email == '' ? '' : Date("Y-m-d h:i:s A",strtotime($contact[$i]->last_email))}}</div>
                                                        </div>
                                                    </a>
                                                </center>
                                            </td>
                                                ...
                                                <center>
                                                    <a  onclick="addContactCounter('meeting','{{$contact[$i]->id}}',this)" style="cursor: pointer;">
                                                        <div class="border border-gray-300 border-dashed rounded py-1 px-1 text-center">
                                                            ...
                                                            <div class="fw-bold text-muted fs-8">{{$contact[$i]->last_meeting == '' ? '' : Date("Y-m-d h:i:s A",strtotime($contact[$i]->last_meeting))}}</div>
                                                        </div>
                                                    </a>
                                                </center>
                                            </td>
                                            <td>
                                                ...
                                                <button onclick="editContact('{{$contact[$i]->id}}',this)" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2"  data-bs-original-title="Edit Contact">

                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="mailto:{{$contact[$i]->email_address}}" class="fw-bolder text-gray-800 text-hover-primary mb-1" onclick="getEmailObj('email','{{$contact[$i]->id}}',this)">{{$contact[$i]->email_address}}</a>
                                                <br>
                                                <a href="{{route('contact.show',$contact[$i]->id)}}" class="fw-normal text-gray-800 text-hover-primary mb-1">{{ucwords($contact[$i]->phone_number)}} </a>
                                            </td>
                                            ...
                                            <td>
                                                <button  class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-original-title="Add a Task" data-bs-toggle="tooltip" data-bs-placement="top" onclick="addTaskContact('{{$contact[$i]->id}}')">
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <button onclick="editContact('{{$contact[$i]->id}}',this)" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2"  data-bs-original-title="Edit Contact" data-bs-toggle="tooltip" data-bs-placement="top">
                                                ...
                                                <form  style="display: inline-block" method="POST" action="{{ route('contact.destroy', $contact[$i]->id) }}">
                                                    @method('DELETE')
                                                    @csrf
                                                <button type="submit" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2" data-bs-toggle="tooltip" data-bs-original-title="Delete Contact" data-bs-placement="top">

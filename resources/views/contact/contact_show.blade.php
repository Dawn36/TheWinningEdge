...
@section('content')
                ...
                <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-center flex-column py-5">
                                    ...
                                    <a class="fs-1 text-gray-800 text-hover-primary fw-bolder mb-3"
                                        style="text-align: center;">{{ ucwords($company->company_name == '' ? 'Company name is not added' : $company->company_name) }}
                                    </a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="mb-9">
                                ...
                                <div id="kt_user_view_details" class="collapse show">
                                    <div class="pb-5 fs-6">
                                        ...
                                        <div class="text-gray-600 text-hover-primary">{{ ucwords($contact->first_name) }}
                                            {{ ucwords($contact->last_name) }}</div>

                                        <div class="fw-bolder mt-5">Mobile phone</div>
                                        <div class="text-gray-600 text-hover-primary">{{ ucwords($contact->mobile_phone) }}
                                        </div>

                                        <div class="fw-bolder mt-5">Email Address</div>
                                        <div class="text-gray-600 text-hover-primary"><a
                                                class=" text-gray-600 text-hover-primary mb-1"
                                                href="mailto:{{ $contact->email }}"
                                                onclick="getEmailObj('email','{{ $contact->id }}',this)">{{ $contact->email }}</a>
                                        </div>

                                        <div class="fw-bolder mt-5">Contact Status</div>
                                        @php $status=explode('_',$contact->status) @endphp
                                        <div class="text-gray-600 text-hover-primary">{{ ucwords($status[0]) }}
                                            {{ count($status) == '2' ? ucwords($status[1]) : '' }}</div>
									...
									<div class="text-gray-600 text-hover-primary">{{ucwords($contact->company_name)}}</div> --}}
                                        ...
                                        <div class="text-gray-600 text-hover-primary">{{ ucwords($contact->phone_number) }}
                                        </div>
                                        ...
                                        <div class="text-gray-600">
                                            <a href="{{ $contact->linked_in_url }}"
                                                class="text-gray-600 text-hover-primary">{{ $contact->linked_in_url }}</a>
                                        </div>
                                        <div class="fw-bolder mt-5">Creation Date</div>
                                        <div class="text-gray-600 text-hover-primary">
                                            {{ Date('m/d/Y', strtotime($contact->created_at)) }}</div>
                                    </div>
                                </div>
                            </div>
                            <!--end::Card body-->
                    ...
                    <div class="flex-lg-row-fluid ms-lg-15">
                        <div class="d-flex flex-center flex-column pb-3 pt-0">
                            <a class="fs-3 text-gray-800 text-hover-primary fw-bolder">Generate Logs by clicking the buttons
                                below</a>
                        </div>
                        <div class="d-flex flex-wrap flex-center fs-8 mb-10">
                            <!--begin::Stats-->
                            <a onclick="addContactCounter('phone_call','{{ $contact->id }}',this)"
                                style="cursor: pointer;">
                                <div
                                    class="bg-light-primary bg-hover-light border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center me-3">
                            ...
                            <!--end::Stats-->
                            <!--begin::Stats-->
                            <a onclick="addContactCounter('live_conversation','{{ $contact->id }}',this)"
                                style="cursor: pointer;">
                                <div
                                    class="bg-light-primary bg-hover-light border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center me-3">
                                    <div class="fs-5 fw-bolder text-gray-700">
                            ...
                            <!--end::Stats-->
                            <!--begin::Stats-->
                            <a onclick="addContactCounter('voice_mail','{{ $contact->id }}',this)"
                                style="cursor: pointer;">
                                <div
                                    class="bg-light-primary bg-hover-light border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center me-3">
                                    <div class="fs-5 fw-bolder text-gray-700">
                            ...
                            <a onclick="addContactCounter('email','{{ $contact->id }}',this)" style="cursor: pointer;">
                                <div
                                    ...
                                    <div class="fw-bold text-muted"># Of Emails</div>
                                </div>
                            </a>
                            <!--end::Stats-->
                            <!--begin::Stats-->
                            <a onclick="addContactCounter('meeting','{{ $contact->id }}',this)"
                                style="cursor: pointer;">
                                <div
                                    class="bg-light-primary bg-hover-light border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center">
                                    <div class="fs-5 fw-bolder text-gray-700">
                                    ...
                                    <div class="fw-bold text-muted"># Of Meetings Scheduled</div>
                                </div>
                            </a>
                            <!--end::Stats-->
                        </div>
                        ...
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8 mt-5">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
                                    href="#kt_user_view_notes_tab">Notes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                    href="#kt_tasks">Tasks</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                    href="#kt_opportunities">Opportunities</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                    href="#kt_phone_calls_logs">Phone Calls</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                    href="#kt_live_conversation_logs">Live Conversations</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                    href="#kt_voicemails_logs">Voicemails</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                    href="#kt_emails_logs">Emails</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                    href="#kt_meetings_logs">Meetings Scheduled</a>
                            </li>
                            <!--end:::Tab item-->
                        </ul>
                        <!--end:::Tabs-->
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    <div class="card-header mt-6">
                                        <div class="card-title flex-column">
                                            ...
                                            <div class="fs-6 fw-bold text-muted">Total {{ count($note) }} Notes in
                                                backlog</div>
                                        </div>
                                        <div class="card-toolbar">
                                            <button type="button" class="btn btn-light-primary btn-sm"
                                                onclick="addContactNote('{{ $contact->id }}')">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none">
                                                        <path opacity="0.3"
                                                        ...
                                                        <rect x="11" y="19" width="10"
                                                            height="2" rx="1" transform="rotate(-90 11 19)"
                                                            fill="black" />
                                        ...
                                        <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                @for ($i = 0; $i < count($note); $i++)
                                                    ...
                                                    <tr>
                                                        <td>{{ $a }}</td>
                                                        <td>{{ ucwords($note[$i]->note) }}</td>
                                                        <td>{{ Date('m/d/Y', strtotime($note[$i]->created_at)) }}</td>
                                                        <td>{{ ucwords($note[$i]->user_name) }}</td>
                                                        <td>
                                                            <button
                                                                class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary"
                                                                data-bs-original-title="Edit Note"
                                                                onclick="editNoteContact('{{ $note[$i]->id }}')">
                                                            ...
                                                            <button type="button"
                                                                onclick="deleteNote('{{ $note[$i]->id }}',this)"
                                    ...
                                    {{-- @php 
                                            ...
                                            @endphp  --}}
                                    {{-- <a href="javascript:;" class="fs-5 fw-bolder text-dark text-hover-primary">{{ucwords($note[$i]->note)}}</a>
                                          
											<div class="fs-7 text-muted">Created On
												<a href="javascript:;">{{Date("m/d/Y",strtotime($note[$i]->created_at))}}</a>
											</div>
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    <div class="card-header mt-6">
                                        <div class="card-title flex-column">
                                            ...
                                            <div class="fs-6 fw-bold text-muted">Total {{ count($task) }} Tasks in
                                                backlog</div>
                                        </div>
                                        <div class="card-toolbar">
                                            <button type="button" class="btn btn-light-primary btn-sm"
                                                data-bs-toggle="modal" data-bs-target="#kt_modal_add_tasks"
                                                onclick="addTaskContact('{{ $contact->id }}')">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none">
                                                        <path opacity="0.3"
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                @for ($i = 0; $i < count($task); $i++)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="badge badge-sm badge-light-primary d-inline">
                                                                {{ ucwords($task[$i]->task_status) }}</div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <button
                                                                ...
                                                                onclick="editTaskContact('{{ $task[$i]->id }}','{{ $contact->id }}')">
                                                                <span class="svg-icon svg-icon-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24"
                                                                        fill="none">
                                                            ...
                                                            <button type="button"
                                                                onclick="deleteTask('{{ $task[$i]->id }}',this)"
                                                                class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                                                                data-bs-toggle="tooltip" data-bs-original-title="Delete">
                                                                <span class="svg-icon svg-icon-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    <div class="card-header mt-6">
                                        <div class="card-title flex-column">
                                            ...
                                            <div class="fs-6 fw-bold text-muted">Total {{ count($task) }} Opportunities
                                                in backlog</div>
                                        </div>
                                        <div class="card-toolbar">
                                            <button type="button" class="btn btn-light-primary btn-sm"
                                                data-bs-toggle="modal" data-bs-target="#kt_modal_add_tasks"
                                                onclick="addOpportunities('{{ $contact->id }}','{{ $companiesId }}')">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none">
                                                        <path opacity="0.3"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="{{ asset($opportunities[$i]->path) }}"
                                                                    target="_blank"
                                                                    class="text-gray-800 text-hover-primary">{{ ucwords($opportunities[$i]->file_name) }}</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="badge badge-sm badge-light-primary d-inline">
                                                                {{ ucwords($opportunities[$i]->status) }}</div>
                                                        </td>
                                                        <td>
                                                            <button
                                                                class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary"
                                                                data-bs-original-title="Edit Opportunities"
                                                                onclick="editOpportunities('{{ $opportunities[$i]->id }}')">
                                                                <span class="svg-icon svg-icon-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24"
                                                                        fill="none">
                                                            ...
                                                            <button type="button"
                                                                onclick="deleteOpportunity('{{ $opportunities[$i]->id }}',this)"
                                                                class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                                                                data-bs-toggle="tooltip" data-bs-original-title="Delete">
                                                                <span class="svg-icon svg-icon-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    <div class="card-header mt-6">
                                        <div class="card-title flex-column">
                                            ...
                                            <div class="fs-6 fw-bold text-muted">Total {{ count($phoneCall) }} Phone Calls
                                                in backlog</div>
                                        </div>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                @for ($i = 0; $i < count($phoneCall); $i++)
                                                    ...
                                                    <tr>
                                                        <td>{{ $a }}</td>
                                                        <td>{{ Date('m/d/Y h:i:s A', strtotime($phoneCall[$i]->created_at)) }}
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('contact_counter_delete', $phoneCall[$i]->id) }}"
                                                                class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                                                                data-bs-toggle="tooltip"
                                                                data-bs-original-title="Delete Phone Call">
                                                                <span class="svg-icon svg-icon-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24"
                                                                        fill="none">
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    <div class="card-header mt-6">
                                        <div class="card-title flex-column">
                                            ...
                                            <div class="fs-6 fw-bold text-muted">Total {{ count($liveConversation) }} Live
                                                Conversations in backlog</div>
                                        </div>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                @for ($i = 0; $i < count($liveConversation); $i++)
                                                    @php
                                                        $a = $i;
                                                        $a++;
                                                    @endphp
                                                    <tr>
                                                        <td>{{ $a }}</td>
                                                        <td>{{ Date('m/d/Y h:i:s A', strtotime($liveConversation[$i]->created_at)) }}
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('contact_counter_delete', $liveConversation[$i]->id) }}"
                                                                class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                                                                data-bs-toggle="tooltip"
                                                                data-bs-original-title="Delete Live Conversation">
                                                                <span class="svg-icon svg-icon-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24"
                                                                        fill="none">
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    <div class="card-header mt-6">
                                        <div class="card-title flex-column">
                                            ...
                                            <div class="fs-6 fw-bold text-muted">Total {{ count($voiceMail) }} Voicemails
                                                in backlog</div>
                                        </div>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                @for ($i = 0; $i < count($voiceMail); $i++)
                                                    ...
                                                    <tr>
                                                        <td>{{ $a }}</td>
                                                        <td>{{ Date('m/d/Y h:i:s A', strtotime($voiceMail[$i]->created_at)) }}
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('contact_counter_delete', $voiceMail[$i]->id) }}"
                                                                class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                                                                data-bs-toggle="tooltip"
                                                                data-bs-original-title="Delete Voice Mail">
                                                                <span class="svg-icon svg-icon-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24"
                                                                        fill="none">
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    <div class="card-header mt-6">
                                        <div class="card-title flex-column">
                                            ...
                                            <div class="fs-6 fw-bold text-muted">Total {{ count($email) }} Emails in
                                                backlog</div>
                                        </div>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                @for ($i = 0; $i < count($email); $i++)
                                                    ...
                                                    <tr>
                                                        <td>{{ $a }}</td>
                                                        <td>{{ Date('m/d/Y h:i:s A', strtotime($email[$i]->created_at)) }}
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('contact_counter_delete', $email[$i]->id) }}"
                                                                class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                                                                data-bs-toggle="tooltip"
                                                                data-bs-original-title="Delete Email">
                                                                <span class="svg-icon svg-icon-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24"
                                                                        fill="none">
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    <div class="card-header mt-6">
                                        <div class="card-title flex-column">
                                            ...
                                            <div class="fs-6 fw-bold text-muted">Total {{ count($meeting) }} Meetings in
                                                backlog</div>
                                        </div>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                @for ($i = 0; $i < count($meeting); $i++)
                                                    ...
                                                    <tr>
                                                        <td>{{ $a }}</td>
                                                        <td>{{ Date('m/d/Y h:i:s A', strtotime($meeting[$i]->created_at)) }}
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('contact_counter_delete', $meeting[$i]->id) }}"
                                                                class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2"
                                                                data-bs-toggle="tooltip"
                                                                data-bs-original-title="Delete Meeting">
                                                                <span class="svg-icon svg-icon-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24"
                                                                        fill="none">
    ...
    <script type="text/javascript">
        ...
        function getEmailObj(status, contactsId, obj) {
            obj = obj.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement
        ...
        function editNoteContact(id) {
            url = "{{ route('edit_note_contact', ':id') }}";
            url = url.replace(':id', id);
            $.ajax({
                type: 'GET',
                url: url,

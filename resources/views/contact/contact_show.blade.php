						...
						<div class="card-body">
							...
							<div class="d-flex flex-center flex-column py-5">
								...
								<div class="symbol symbol-100px symbol-circle mb-7">
									<img src="{{asset( $contact->profile_img) }}" alt="image" />
								</div>
								<!--end::Avatar-->
								<!--begin::Name-->
								<a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3">{{ucwords($contact->first_name)}} {{ucwords($contact->last_name)}}</a>
								<!--end::Name-->
								<!--begin::Position-->
								<div class="mb-9">
									<!--begin::Badge-->
								...
								<div class="fw-bolder mb-3">Total Count
									<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Total count of # Of Phone Calls, # Of Live Conversations, # Of Voicemails, # Of Emails, # Of Meetings"></i>
								</div>
								<!--end::Info heading-->
								<div class="d-flex flex-wrap flex-center fs-8">
									<!--begin::Stats-->
									<a href="" onclick="addContactCounter('phone_call','{{$contact->id}}')">
										<div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center me-3">
									...
									<!--end::Stats-->
									<!--begin::Stats-->
									<a href="" onclick="addContactCounter('live_conversation','{{$contact->id}}')">
										<div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center me-3">
											<div class="fs-5 fw-bolder text-gray-700">
									...
									<!--end::Stats-->
									<!--begin::Stats-->
									<a href="" onclick="addContactCounter('voice_mail','{{$contact->id}}')">
										<div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center me-3">
											<div class="fs-5 fw-bolder text-gray-700">
									...
									<!--end::Stats-->
									<!--begin::Stats-->
									<a href="" onclick="addContactCounter('email','{{$contact->id}}')">
										<div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3 text-center me-3">
											<div class="fs-5 fw-bolder text-gray-700">
									...
									<!--end::Stats-->
									<!--begin::Stats-->
									<a href="" onclick="addContactCounter('meeting','{{$contact->id}}')">
							...
							<div id="kt_user_view_details" class="collapse show">
								<div class="pb-5 fs-6">
									<div class="fw-bolder mt-5">Contact ID</div>
									<div class="text-gray-600 text-hover-primary">{{$contact->id}}</div>
								...
								<div class="card-body d-flex flex-column">
									<table class="kt_datatable_example_1 table table-row-bordered gy-5">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												<td>{{$a}}</td>
												<td>{{Date("Y-m-d",strtotime($phoneCall[$i]->created_at))}}</td>
												<td>
								...
								<div class="card-body d-flex flex-column">
									<table class="kt_datatable_example_1 table table-row-bordered gy-5">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												<td>{{$a}}</td>
												<td>{{Date("Y-m-d",strtotime($liveConversation[$i]->created_at))}}</td>
												<td>
								...
								<div class="card-body d-flex flex-column">
									<table class="kt_datatable_example_1 table table-row-bordered gy-5">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												<td>{{$a}}</td>
												<td>{{Date("Y-m-d",strtotime($voiceMail[$i]->created_at))}}</td>
												<td>
								...
								<div class="card-body d-flex flex-column">
									<table class="kt_datatable_example_1 table table-row-bordered gy-5">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												<td>{{$a}}</td>
												<td>{{Date("Y-m-d",strtotime($email[$i]->created_at))}}</td>
												<td>
								...
								<div class="card-body d-flex flex-column">
									<table class="kt_datatable_example_1 table table-row-bordered gy-5">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												<td>{{$a}}</td>
												<td>{{Date("Y-m-d",strtotime($meeting[$i]->created_at))}}</td>
												<td>

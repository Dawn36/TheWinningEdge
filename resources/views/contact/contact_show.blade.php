						...
						<div class="card-body">
							...
							<div class="d-flex flex-stack fs-4 py-3">
								...
								<span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit customer details">
									<button  class="btn btn-sm btn-light-primary" onclick="editContactNot('{{$contact->id}}')" >Edit</button>
								</span>
							</div>
							<!--end::Details toggle-->
							...
							<div id="kt_user_view_details" class="collapse show">
								<div class="pb-5 fs-6">
									...
									<div class="text-gray-600 text-hover-primary">{{Date("m/d/Y",strtotime($contact->created_at))}}</div>
								</div>
							</div>
						</div>
						<!--end::Card body-->
								...
								<div class="card-body d-flex flex-column">
									<table class="kt_datatable_example_1 table table-row-bordered gy-5">
										...
										<tbody class="fw-bold text-gray-600">
											@for ($i = 0; $i < count($note); $i++) @php $a=$i; $a++; @endphp 
											<tr>
												<td>{{$a}}</td>
												...
												<td>
													<button  class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary"  data-bs-original-title="Edit Note" onclick="editNoteContact('{{$note[$i]->id}}')">
